...
import tarfile
# sys.path.append("..")
import smModule.bioSlim3 as bio
import argparse
...
def processBlastResult(blastFile, translationFile, pident_cutoff = 90, q_coverage_cutoff = 90, s_coverage_cutoff = 90, aspmineIdsOnly = True):
	"""
	...
	# "/home/seth/asptoolbox/secMet/mibig/mibigVsSmurf.txt"
	try:
...
# papers = ["NigriPaperSet"]
# print(os.getcwd())
#
# for paper in papers:
# 	if not os.path.exists("../" + paper):
# 		os.makedirs("../" + paper)
# 	if not os.path.exists("../" + paper + "/mibig"):
# 		os.makedirs("../" + paper + "/mibig")

# geneClusters = processMibig("/home/seth/aspmineSM/mibig/mibig_gbk_1.3")

# Echino = [gb for gb in geneClusters if "Echinocandin" in gb.description]
...
# # backbone = max(bb, key = len)
# # return(backbone)
# len(getLargestProtein(Echino[0]))

#
# if __name__ == '__main__':
# 	parser=argparse.ArgumentParser(
# 	description='''Script to download the mibig database in gbk format and extract the largest protein for identification in our dataset.''')
# 	parser.add_argument("--download_mibig", "-d", dest = "download", help="Choose to download mibig database",action = "store_true", default = False)
# 	parser.add_argument("--orgs", "-o", dest="filename", required=True,
...
#
# 	print(os.getcwd())
# 	with open(args.filename, "r") as tmp:
...
# 	print("Downloaded smurf")
#
# 	try:
# 		print("Formatting smurf database")
# 		os.system("formatdb -i smurf.fasta")
# 	except Exception as e:
# 		raise
# 		print(os.getcwd())
...
#
# 	print("Processing")
# 	mibigBlastProc = processBlastResult(blastFile, translationFile)
# 	mibigBlastProc.to_csv("mibigMapping.tsv", sep = '\t')
#
# # TODO:
# # Add annotation and blast file as arguments
