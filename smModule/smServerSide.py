...
Todo:
* Command line usage can be enable as e.g. python3 createSmBiblastTable I_Flavi_biblast smurf_bidir_hits_flavi.
...
def tmpSmBiTable(smtable = "null"):
	...
	if smtable == "null":
		raise ValueError("smtable argument needs to be provided. Try e.g. tmpSmBiTable('nigri_biblast')")
...
# For run alone script it
# if __name__ == '__main__':
#     import sys
#
#     createSmBiblastTable(table = sys.argv[0], smBiTable = sys.argv[1])
#
